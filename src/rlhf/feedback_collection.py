...
class FeedbackExample:
    ...
    prompt: str
    responses: List[Dict[str, Any]]  # [{"text": "...", "rating": 5, "model": "model_a"}]
    feedback_id: str
    timestamp: float
...
class FeedbackCollector:
    ...
    def create_feedback_interface_cli(self, prompt: str, responses: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    def create_feedback_interface_web(self, prompt: str, responses: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    def collect_feedback_batch(self, prompts: List[str], model_responses: List[List[str]], 
                              models: List[str] = None, interface: str = "cli") -> FeedbackDataset:
    ...
    def generate_synthetic_feedback(self, prompts: List[str], model_responses: List[List[str]], 
                                   models: List[str] = None) -> FeedbackDataset:
    ...
    def _generate_synthetic_rating(self, response: str, prompt: str) -> int:
        ...
        if any(word in response.lower() for word in ["example", "specifically", "detailed"]):
            score += 1
    ...
    def save_feedback_dataset(self, dataset: FeedbackDataset, filename: str = None) -> str:
