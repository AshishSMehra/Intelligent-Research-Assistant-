...
class ModelRegistry:
    ...
    def register_model_wandb(
        ...
        logger.info(f"Model registered successfully in W&B: {model_metadata.model_name}")
        return model_metadata.model_name
    
    def list_registered_models(self, registry_type: str = "mlflow") -> List[Dict[str, Any]]:
        """
...
"""
    ...
    def log_model_version_wandb(self, model_path: str, model_metadata: ModelMetadata) -> str:
