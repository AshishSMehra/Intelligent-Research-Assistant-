...
class ModelEvaluation:
    ...
    def generate_responses(
        self, test_dataset: Dataset, max_length: int = 512, temperature: float = 0.7
    ) -> List[str]:
        """
    ...
    def evaluate_model(
        self, test_dataset: Dataset, reference_responses: Optional[List[str]] = None
    ) -> EvaluationMetrics:
        """
    ...
    def create_evaluation_report(
        self, metrics: EvaluationMetrics, model_path: str, dataset_info: Dict[str, Any]
    ) -> str:
        """
