...
class RBACManager:
    ...
    def get_role(self, role_name: str) -> Optional[Role]:
        ...
        try:
            ...
            permissions = {Permission(perm) for perm in role_data.get("permissions", "").split(",") if perm}
    ...
    def get_user(self, user_id: str) -> Optional[User]:
        ...
        try:
            ...
            return User(
                ...
                last_login=float(user_data.get("last_login", 0)) if user_data.get("last_login") else None,
    ...
    def authenticate_user(self, username: str, password: str) -> Optional[str]:
        ...
        try:
            ...
            if password:  # Simple check for demo
                # Update last login
                self.redis_client.hset(f"user:{user.user_id}", "last_login", str(time.time()))
