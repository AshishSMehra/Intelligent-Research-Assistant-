...
class ChatService:
    ...
    async def process_query(self, chat_query: ChatQuery) -> ChatResponse:
        ...
        try:
            ...
            session_id = chat_query.metadata.session_id if chat_query.metadata else "default_session"
    ...
    def _prepare_metadata(
        ...
        return {
            ...
            "context_chunks_used": llm_response["metadata"].get("context_chunks_used", 0)
        }
